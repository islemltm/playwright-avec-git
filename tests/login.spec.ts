...
test ('login valide',{tag:'@regression'},async({page})=>{
...
test ('Login invalide',{tag:["@smoke","@integration"]},async ({page})=>{
...
test ('Login invalide2',{tag:["@invalide","@regression"]},async ({page})=>{
    // accéder vers la page d'accueil
...
test ('Login invalide3',{tag:["@smoke","@integration"]},async ({page})=>{
    // accéder vers la page d'accueil
...
test ('Login invalide4',{tag:["@invalide","@integration"]},async ({page})=>{
    // accéder vers la page d'accueil
...
test ('Login invalide5',{tag:["@invalide","@test","@integration"]},async ({page})=>{
    // accéder vers la page d'accueil
